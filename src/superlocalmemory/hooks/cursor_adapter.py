...
_BODY_TEMPLATE = (
    ...
    "_Managed by SuperLocalMemory v{version}. This file contains no recalled memory._\n\n"
    "{protocol}\n"
    "---\n"
...
def render_cursor(payload: ContextPayload | None = None) -> bytes:
