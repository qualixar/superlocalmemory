...
- `.github/prompts/*.prompt.md` — 11 slash-command skills: slm-cache · slm-compress · slm-governance · slm-graph · slm-mesh · slm-profile · slm-recall · slm-remember · slm-scope · slm-session · slm-status.
